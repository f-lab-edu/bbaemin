...
public class OrderDetailResponse {
    ...
    @Builder
    private OrderDetailResponse(String status, String store, String description, String paymentAmount, String orderDate, String orderId, List<OrderItemResponse> orderItemList, String orderAmount, String deliveryFee, String paymentMethod, String deliveryAddress, String phoneNumber, String email, String messageToRider) {
        this.status = status;
        this.store = store;
